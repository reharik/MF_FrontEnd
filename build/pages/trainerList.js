...
module.exports = React.createClass({
  ...
  render: function() {
      ...
      React.createElement("div", null, 
        React.createElement("h2", null, "Trainer List"), 
        React.createElement(Griddle, {results: this.state.trainerSummaries, columns: columns, columnMetadata: columnDefs, enableInfiniteScroll: true, resultsPerPage: 5})
      )
    );
  }
});
