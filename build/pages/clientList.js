...
module.exports = React.createClass({
  ...
  render: function() {
      ...
      React.createElement("div", null, 
        React.createElement("h2", null, "Client List"), 
        React.createElement(Griddle, {results: this.state.clientSummaries, columns: columns, columnMetadata: columnDefs, enableInfiniteScroll: true, resultsPerPage: 5})
      )
    );
  }
});
